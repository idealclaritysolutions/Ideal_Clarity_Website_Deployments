...
export default function JanuaryResetClient() {
  return (
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-card border-2 border-primary/30 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <div className="border-t border-border pt-6 space-y-4">
                ...
                <div className="space-y-3">
                  <Button
                    className="w-full bg-primary hover:bg-primary/90 text-white py-6 text-lg rounded-full shadow-lg"
            ...
            <div className="bg-card border-2 border-secondary/30 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <div className="border-t border-border pt-6 space-y-4">
                ...
                <div className="space-y-3">
                  <Button
                    className="w-full bg-secondary hover:bg-secondary/90 text-white py-6 text-lg rounded-full shadow-lg"
                    onClick={() => (window.location.href = "https://buy.stripe.com/00wfZi0fU9nbezdf23dAk0b")}
                  >
                    Pay in Full - $2,997
                  </Button>
                  <Button
                    ...
                    onClick={() => (window.location.href = "https://buy.stripe.com/3cIcN62o28j78aP079dAk0c")}
                  >
                    Payment Plan - $1,500 Today
                  </Button>
                  <p className="text-xs text-center text-muted-foreground">
            ...
            {/* Hybrid Path */}
            <div className="bg-card border-2 border-accent/30 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 relative overflow-hidden">
              ...
              <p className="text-muted-foreground mb-6">Build your business WHILE pursuing corporate stability</p>

              <div className="space-y-3 mb-6">
                <h4 className="font-semibold text-accent">By January 25th, you'll have:</h4>
                {[
                  "Dual-track clarity (corporate targets + business idea validated)",
                  "Complete corporate materials (resume, LinkedIn, applications)",
                  "Business foundation (website LIVE, offer & pricing set)",
                  "Dual execution plan (job search + business launch)",
                  "Visibility strategy for BOTH paths",
                  "30-day roadmap (job search + business outreach)",
                ].map((item, index) => (
                  <div key={index} className="flex items-start gap-2">
              ...
              <p className="text-sm text-muted-foreground mb-6 italic">
                Then: 4 weeks of accountability - you execute on BOTH tracks with full support
              </p>
              ...
              <div className="border-t border-border pt-6 space-y-4">
                <div>
                  <div className="flex items-baseline gap-2 mb-1">
                    ...
                    <span className="text-muted-foreground line-through">$8,500</span>
                  </div>
                  <p className="text-sm text-primary font-semibold">Save $3,500 - Workshop Exclusive</p>
                </div>

                <div className="space-y-3">
                  <Button
                    className="w-full bg-accent hover:bg-accent/90 text-white py-6 text-lg rounded-full shadow-lg"
                    onClick={() => (window.location.href = "https://buy.stripe.com/dRm14oe6K7f3bn17zBdAk0d")}
                  >
                    Pay in Full - $5,000
                  </Button>
                  <p className="text-xs text-center text-muted-foreground">One-time payment only</p>
                </div>
              </div>
            </div>
          </div>
