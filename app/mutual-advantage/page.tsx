    ...
    <main>
      ...
      <section className="credStrip" aria-label="Chi-Chi's interview track record">
        <div className="shell credStripInner">
          <span>34 Interviews</span>
          <span className="credArrow" aria-hidden="true">→</span>
          <span>1 Offer</span>
          <span className="credArrow" aria-hidden="true">→</span>
          <span>Built the Method</span>
          <span className="credArrow" aria-hidden="true">→</span>
          <strong>~80% Interview Success Rate</strong>
        </div>
      </section>
      ...
      <section className="section origin">
        <div className="shell narrow centered">
          ...
          <div className="originStory">
            <p>I didn’t build this because I worked in HR.</p>
            <p>I built it because I spent years asking the wrong question.</p>
