    ...
    <main className="tc-root">
      ...
      <section className="tc-hero">
        <div className="tc-shell tc-center">
          ...
          <p className="tc-hero-sub" data-reveal>
            This short video explains why you may have spent years postponing what already feels meaningful.
          </p>
      ...
      <section className="tc-section tc-cream">
        <div className="tc-narrow tc-center">
          ...
          <p className="tc-pull" data-reveal>
            You need help understanding why you keep walking away from what already matters to you.
          </p>
        </div>
      </section>
        ...
        <div className="tc-shell tc-about">
          ...
          <div className="tc-about-copy" data-reveal>
            ...
            <div className="tc-body">
              <p>I help accomplished professionals understand why they keep postponing the work, idea, or life that feels most meaningful to them.</p>
      ...
      <section className="tc-section tc-navy" id="offer">
        <div className="tc-narrow tc-center">
          ...
          <h2 className="tc-display-light" data-reveal>The conversation you may have needed for years.</h2>
          <p className="tc-lead tc-light-copy" data-reveal>
            A private 75-minute conversation designed to help you see what you cannot see from inside your own story.
          </p>
          ...
          <div className="tc-offer-card" data-reveal>
            <div className="tc-offer-grid">
              ...
              <article>
                ...
                <p>You leave knowing exactly what to do next, without a ten-step plan or pressure to change your entire life.</p>
              </article>
            </div>
      ...
      <section className="tc-section tc-cream">
        <div className="tc-shell tc-book">
          ...
          <div className="tc-book-card" data-reveal>
            <div className="tc-book-cover">
              <span>BUILD</span><span>WHAT&apos;S</span><span>NEXT</span>
              <small>WHILE STILL EMPLOYED</small>
            </div>
      ...
      <section className="tc-section" id="book">
        <div className="tc-narrow tc-center">
          ...
          <p className="tc-lead" data-reveal>Choose a time. Answer four thoughtful questions. I will read every word before we meet.</p>
      ...
      <div className={`tc-sticky ${showSticky ? "is-visible" : ""}`}>
        ...
        <button type="button" className="tc-sticky-button" onClick={() => scrollToId("book")}>Yes</button>
      </div>
    </main>
  );
}
